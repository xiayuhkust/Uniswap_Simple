...
contract VerifyPoolAddresses3 is Script {
    ...
    function run() public {
        ...
        console.log("Expected pool address: 0x089A50C3868E1dd1FdC670CF5F1Bd5BB03AbfC1D");
        ...
        console.log("Expected pool address: 0xB8aD8416742C6B5e4D00A5e8A0cfb0129c37101f");
        ...
        console.log("Expected pool address: 0x6EFb56d87BC31598d030Ece8E2067ce5d9aE1692");
    }
}
